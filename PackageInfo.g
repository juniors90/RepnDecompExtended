...
PackageName := "RepnDecompExtended",
...
PackageDoc := rec(
  BookName  := "RepnDecompExtended",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := " The GAP package for handling representations of groups and categories in positive characteristic",
),
